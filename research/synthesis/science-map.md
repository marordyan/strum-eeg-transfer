...
| classical handcrafted features | logistic regression at 0.847 on EEGMAT against the best foundation-model tier at 0.755 ([lin-2026-identity-trap](../collection/eeg-models/lin-2026-identity-trap/card.md)); classical features beating frozen REVE by at least 12.7 points under every tested CAUEEG condition ([zare-2026-stress-testing](../collection/eeg-models/zare-2026-stress-testing/card.md)) | — |
